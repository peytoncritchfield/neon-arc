 ...
 */
// Geometry
const waterGeometry = new THREE.PlaneGeometry(1, 20, 512, 512)
...
gui.add(waterMaterial.uniforms.uBigWavesSpeed, 'value', 0, 10, 0.001).name('uBigWavesSpeed')
...
gui.add(waterMaterial.uniforms.uSmallWavesIterations, 'value', 0, 5, 1).name('uSmallWavesIterations')
